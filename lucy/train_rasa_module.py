...
from nlu_train import trainNluModel
...
class TrainBot:
	...
	def __init__(self):
		...
		# self.training_data_nlu = "./training_data.md"
		self.training_data_nlu = "./testData.json"
		self.conf_path_nlu = "./nlu_config.yml"
		self.training_data_core = './stories.md'
		self.model_path_core = './models/dialogue'
		self.model_path_nlu = './projects/default/default/rasa_bot'
